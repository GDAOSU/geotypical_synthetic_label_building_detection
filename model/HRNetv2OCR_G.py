...
class HRNetV2OCR(nn.Module):
    ...
    def __init__(self, n_class, **kwargs):
        super(HRNetV2OCR, self).__init__()
        self.return_aug = kwargs.get('return_aug', False)
        # stem net
        ...
        self.aux_head = nn.Sequential(
            ...
            nn.ReLU(inplace=True),
            nn.Conv2d(last_inp_channels, n_class,
    ...
    def get_1x_lr_params_NOscale(self):
        ...
        b.append(self.transition1)
        b.append(self.stage2)
        b.append(self.transition2)
        b.append(self.stage3)
        b.append(self.transition3)
    ...
    def get_10x_lr_params(self):
        ...
        """
        b = []
        b.append(self.cls1.parameters())
        b.append(self.cls2.parameters())
        b.append(self.aux_head.parameters())
        b.append(self.conv3x3_ocr.parameters())
        b.append(self.ocr_distri_head.parameters())
        b.append(self.ocr_gather_head.parameters())
...
class HRNetV2OCRw48(HRNetV2OCR):
    extra = {
        'STAGE2': {'NUM_MODULES': 1, 'NUM_BRANCHES': 2, 'BLOCK': 'BASIC', 'NUM_BLOCKS': (4, 4),
    ...
    def __init__(self, n_class, **kwargs):
        super(HRNetV2OCRw48, self).__init__(n_class, **kwargs)

if __name__ == '__main__':
    import torchsummary

    model = HRNetV2OCRw48(n_class=6).cuda()
    torchsummary.summary(model,(3, 256, 256))
    # image_s = torch.rand((4,3,256,256))
    # out = model(image_s)
