...
SNAPSHOT_DIR =  f'./snapshots/{MODEL}_{SOURCE}_2_{TARGET}_clan'
...
def main():
    ...
    trainloader = data.DataLoader(
        CityEngineDataSet(args.data_dir, args.data_list, max_iters=args.num_steps * args.iter_size * args.batch_size,
