...
class GDADataSet(data.Dataset):
    def __init__(self, root, list_path, max_iters=None, crop_size=(256, 256),
                 mean=(82.32, 94.43, 107.41), scale=True, mirror=True, ignore_label=255):
        self.root = root
...
if __name__ == '__main__':
    dst = CityEngineDataSet("./dataset/SpiralGen", './dataset/SpiralGen/train.txt')
